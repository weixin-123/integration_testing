...
"""
from test_case.debt.data_check.data_fractionation import DataFractionation
...
class OrderCheck:
    def test_assert_data(self):
        ...
        # # 待完成解债笔数
        # creating_total = creating_one + creating_two + creating_three + creating_four + creating_five + creating_six + creating_seven
        ...
        # # 已完成解债笔数
        # creating_total = completed_one + completed_two + completed_three + completed_four + completed_five + completed_six + completed_seven + completed_eight
        ...
        # #
        # # 已完成解债金额  60 130
        # completed_total = DataFractionation().dev_cash_complete_second_step()
        ...
        #
        # # 总已还债权微币
        # all_repaymented = DataFractionation().dev_all_to_be_completed()
